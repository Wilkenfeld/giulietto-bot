...
CREATE TABLE IF NOT EXISTS `dev_user_chat` (
...
CREATE TABLE IF NOT EXISTS `dev_inline_query` (
...
CREATE TABLE IF NOT EXISTS `dev_chosen_inline_result` (
...
CREATE TABLE IF NOT EXISTS `dev_edited_message` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
  `chat_id` bigint COMMENT 'Unique chat identifier',
...
CREATE TABLE IF NOT EXISTS `dev_callback_query` (
  `id` bigint UNSIGNED COMMENT 'Unique identifier for this query',
  `user_id` bigint NULL COMMENT 'Unique user identifier',
...
CREATE TABLE IF NOT EXISTS `dev_shipping_query` (
...
CREATE TABLE IF NOT EXISTS `dev_pre_checkout_query` (
  `id` bigint UNSIGNED COMMENT 'Unique query identifier',
  `user_id` bigint COMMENT 'User who sent the query',
...
CREATE TABLE IF NOT EXISTS `dev_poll` (
...
CREATE TABLE IF NOT EXISTS `dev_poll_answer` (
...
CREATE TABLE IF NOT EXISTS `dev_chat_member_updated` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
...
CREATE TABLE IF NOT EXISTS `dev_chat_join_request` (
  `id` BIGINT UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
...
CREATE TABLE IF NOT EXISTS `dev_telegram_update` (
...
CREATE TABLE IF NOT EXISTS `dev_conversation` (
...
CREATE TABLE IF NOT EXISTS `dev_request_limiter` (
  `id` bigint UNSIGNED AUTO_INCREMENT COMMENT 'Unique identifier for this entry',
